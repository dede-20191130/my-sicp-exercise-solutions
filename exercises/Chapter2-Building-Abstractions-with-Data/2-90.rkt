...
(define (install-polynomial-package)
  ...
  (put 'make-term-list 'polynomial make-term-list )
  'done)
...
(define (make-term-list tgt-density tgt-term-list-cont)
  ((get 'make-term-list 'polynomial) tgt-density tgt-term-list-cont))
...
(define poly-dns-1 (make-polynomial 'x (make-term-list 'dense '(2.2 0 1.7))))
(define poly-dns-2 (make-polynomial 'x (make-term-list 'dense '(5 7))))

(define poly-sp-1 (make-polynomial 'x (make-term-list 'sparse (list term-x-3 term-x-2 term-x-1))))
(define poly-sp-2 (make-polynomial 'x (make-term-list 'sparse (list term-x-8 term-x-7 term-x-6))))


(print-line poly-dns-1)
(print-line poly-dns-2)
(print-line "----------------")
(print-line (add poly-dns-1 poly-dns-1))
(print-line (add poly-dns-1 poly-dns-2))
(print-line (mul poly-dns-1 poly-dns-1))
(print-line (mul poly-dns-1 poly-dns-2))
(print-line "----------------")
(print-line poly-sp-1)
(print-line poly-sp-2)
(print-line "----------------")
(print-line (add poly-sp-1 poly-sp-1))
(print-line (add poly-sp-1 poly-sp-2))
(print-line (mul poly-sp-1 poly-sp-1))
(print-line (mul poly-sp-1 poly-sp-2))
(print-line "----------------")
(print-line (add poly-dns-1 poly-sp-1))
(print-line (add poly-sp-1 poly-dns-1))
(print-line (sub poly-sp-1 poly-dns-1))
(print-line (sub poly-dns-1 poly-sp-1))