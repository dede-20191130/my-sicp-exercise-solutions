...
(define (apply-generic op . args)
  ...
  (define (drop-as-possible tgt-data)
    ;    (print-line tgt-data)
    ;    (print-line (eq? op 'drop));comm
    ;    (print-line (not (droppable? tgt-data)));comm
...
(print-line (div (make-polynomial 'x (make-term-list 'dense '(3 0 0 0 0 -1))) (make-polynomial 'x (make-term-list 'dense '(1 0 -1)))))
(print-line (div (make-polynomial 'x (make-term-list 'dense '(4 3 2 1))) (make-polynomial 'x (make-term-list 'dense '(1 1 1)))))