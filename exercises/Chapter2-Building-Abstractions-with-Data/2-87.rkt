...
(define poly1 (make-polynomial 'x (list term-x-1 term-x-2 term-x-3)))
(define poly2 (make-polynomial 'x (list term-x-4 term-x-5)))
(define poly3 (make-polynomial 'y (list term-x-4 term-x-5)))

(define term-x-6 (make-term 3 poly3))
(define poly4 (make-polynomial 'x (list term-x-4 term-x-6)))
(define poly5 (make-polynomial 'x (list term-x-1 term-x-6)))

(print-line (=zero? poly1))
(print-line poly2)
(print-line (=zero? poly2))
(print-line poly3)
(print-line (=zero? poly3))
(print-line poly4)
(print-line (=zero? poly4))
(print-line (=zero? poly5))
