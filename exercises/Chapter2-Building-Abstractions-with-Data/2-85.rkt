...
(print-line (add comp-droppable1 comp-droppable2))
(print-line (add num1 num2))
(print-line (exp rat-droppable1 comp-droppable3))
(print-line (sub comp-droppable1 comp1))