...
(define comp3 (make-complex-from-mag-ang 5 (/ pi 3)))


(define num1 (make-scheme-number 7))
(define num2 (make-scheme-number -6))
(define num3 (make-scheme-number -6))

(print-line (equ? num1 num2))
(print-line (equ? num2 num3))
(print-line (equ? comp1 comp2))
(print-line (equ? comp2 comp3))
