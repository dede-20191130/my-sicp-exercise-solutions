...
(define (install-polynomial-package)
  ...
  (define (negate-terms L)
    (if (null? L)
        nil
        (cons (make-term (order (first-term L)) (do-negate (coeff (first-term L)))) (negate-terms (rest-terms L)))))
...
(define poly1 (make-polynomial 'x (list term-x-3 term-x-2 term-x-1)))
(define poly2 (make-polynomial 'x (list term-x-5 term-x-4)))
(define poly3 (make-polynomial 'y (list term-x-5 term-x-4)))

(define term-x-6 (make-term 3 poly3))
(define term-x-7 (make-term 0 rat1))
(define term-x-8 (make-term 1 rat2))

(define poly4 (make-polynomial 'x (list term-x-6 term-x-4)))
(define poly5 (make-polynomial 'x (list term-x-6 term-x-1)))

(define poly6 poly1)
(define poly7 (make-polynomial 'x (list term-x-8 term-x-7)))

(print-line (do-negate num1))
(print-line  poly1)
(print-line (do-negate poly1))
(print-line "----------------")
(print-line (sub poly1 poly2))
(print-line (sub poly1 poly6))
(print-line (=zero? (sub poly1 poly6)))
(print-line "----------------")
(print-line (do-negate poly7))
(print-line (sub poly1 poly7))
(print-line "----------------")
(print-line poly1)
