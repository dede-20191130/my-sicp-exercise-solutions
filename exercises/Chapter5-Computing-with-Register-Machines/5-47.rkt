...
(compile-and-go
 '(begin
    (define (proc5-47-cmpl)
      (proc5-47-rntime)) ;;; rntime will be defined on repl
    (define (proc5-47-cmpl-2)
      (let ((tmp (* 5 (proc5-47-rntime)))) ;;; rntime will be defined on repl
        (- tmp 10)))
    (define (proc5-47-cmpl-3) (+ 1 (proc5-47-rntime))) ;;; rntime will be defined on repl
;    (define (proc) 'aaa)
;    (define (proc2) aaa)
    ))
