...
(define cmpled-lookup-example (compile
                               '((lambda (x y)
                                   (lambda (a b c d e)
                                     ((lambda (y z) (* x y z))
                                      (* a b x)
...
(define cmpled-lookup-let-example (compile
                                   '(let ((x 3) (y 4))
                                      (lambda (a b c d e)
                                        (let ((y (* a b x))
                                              (z (+ c d x)))
...
(define cmpled-finding-globalvar (compile
                                  '(begin
                                      (define x 10)
                                      (define y (+ x 20)))
                                  'val
...
(statements cmpled-lookup-example)

(statements cmpled-lookup-let-example)

(statements cmpled-finding-globalvar)
